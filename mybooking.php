...
<section class="bookings">
   ...
   <div class="box">
      ...
      <p>check out : <span><?= $fetch_booking['check_out']; ?></span></p>
            <p>adults : <span><?= $fetch_booking['adult']; ?></span></p>
      <p>childs : <span><?= $fetch_booking['child']; ?></span></p>
      <p>rooms : <span><?= $fetch_booking['room']; ?></span></p>
      <p>booking id : <span><?= $fetch_booking['booking_id']; ?></span></p>
      <form action="" method="POST">
         <input type="hidden" name="booking_id" value="<?= $fetch_booking['booking_id']; ?>">
         <input type="submit" value="cancel booking" name="cancel" class="hero-btn" onclick="return confirm('cancel this booking?');">
      </form>
   </div>
   <?php
    }
   ...
   <div class="box" style="text-align: center;">
      ...
      <a href="booking" class="hero-btn">book new</a>
   </div>
   <?php
   }
   ?>
